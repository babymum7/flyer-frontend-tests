              ...
              <div className="relative flex flex-col w-full max-w-xs pb-12 overflow-y-auto bg-white shadow-xl">
                ...
                <div className="px-4 py-6 space-y-6 border-t border-gray-200">
                  <div className="flow-root">
                    <span className="block p-2 -m-2 font-medium text-gray-900">Sign in</span>
                  </div>
                  <div className="flow-root">
                    <span className="block p-2 -m-2 font-medium text-gray-900">Create account</span>
                  </div>
                </div>

                <div className="px-4 py-6 border-t border-gray-200">
                  <span className="flex items-center p-2 -m-2">
                    <img
              ...
              <div className="flex items-center h-16">
                ...
                <div className="flex items-center ml-auto">
                  ...
                  <div className="flow-root ml-4 lg:ml-6">
                    <span className="flex items-center p-2 -m-2 group">
                      <ShoppingBagIcon
